...
class StudentController:
    ...
    def addStudent(self, student):
        ...
        cursor.execute("INSERT INTO student VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)", student.getValues())
    ...
    def getStudentById(self, student_id):
        ...
        query = ("""SELECT id_etd, cin_etd, cne_etd, nom_etd, prenom_etd, date_n_etd, num_etd,
                 mail_etd, filiere FROM student WHERE id_etd = %s""")
    ...
    def getAllStudents(self):
        cursor = self.connection.cursor()
        query = """SELECT id_etd, cin_etd, cne_etd, nom_etd, prenom_etd, date_n_etd, num_etd, mail_etd, filiere
                 FROM student"""
    ...
    def updateStudent(self, student):
        ...
        num_etd = %s, mail_etd = %s, filiere = %s
        WHERE id_etd = %s
        """
        cursor.execute(query, (student.cin_etd, student.cne_etd, student.nom_etd,
                               ...
                               student.filiere, student.id_etd))
        self.connection.commit()
        cursor.close()
